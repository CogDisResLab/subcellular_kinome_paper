...
comparisons <- list(Comp1 = c("NUCLEAR", "CYTOSOLIC"))
...
#sve LFC table
#write_delim(diff_df, "NUCLEAR_vs_CYTOSOLIC__LFC_table.txt", delim = "\t")
...
### NUCLEAR vs CYTOSOLIC (Upstream Kinase Analysis)
...
# save file
AvgZTable %>% write_delim("../processed_data/comparisons/NUCLEAR_vs_CYTOSOLIC_KRSA_Table_acrossChip.txt", delim = "\t")
...
# save file
AvgZTable2 %>% write_delim("../processed_data/comparisons/NUCLEAR_vs_CYTOSOLIC_KRSA_Table_withinChip.txt", delim = "\t")
